...
const BattleStateRender: React.FC<BattleReportProps> = ({ report }) => {
  ...
  return (
    ...
    <div css={css`display:flex; flex-direction:column; align-content:space-around;`}>
      <h5>Hero {report.your_hero?.name} </h5>
      <div css={css`display:flex; flex-direction:row; align-content:space-around;justify-content: space-between;
    align-items: baseline;`}>
        <Img key={(report.your_hero?.name + "wea")}
          css={css`
        width: 50px;
        height: 50px;
        `}
        ...
        <Img key={(report.your_hero?.name + "eng")}
          css={css`
        width: 50px;
        height: 50px;
        `}
        ...
        <Img key={(report.your_hero?.name + "bio")}
          css={css`
        width: 50px;
        height: 50px;
        `}
        ...
        <Img key={(report.your_hero?.name + "psy")}
          css={css`
        width: 50px;
        height: 50px;
        `}
